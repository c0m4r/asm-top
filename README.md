...
```bash
wget https://github.com/c0m4r/asm-top/releases/download/0.2.0/asm-top
echo "10efacf4673df0057bf16c1f4701603b9192c07bea2770615526ef8ff4034796  asm-top" | sha256sum -c || rm -f asm-top
